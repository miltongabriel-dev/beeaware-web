-- Retry of 20260905270000's debug run after fixing the UTF-8 BOM
-- stripping bug (was being decoded as windows-1252 instead of UTF-8,
-- which mangled the BOM into 3 garbage characters in front of
-- "num_expediente" and crashed column lookup).
do $$
declare
  req_id bigint;
  resp record;
